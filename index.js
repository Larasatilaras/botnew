...
const mess = {
   ...
   "only": {
       ...
       "pribadi": "```「 Private Only 」```"
        ...
        const freply = (teks) => {
            hexa.sendMessage(from, teks, text, {quoted:mek, contextInfo:{"externalAdReply":{"title": fake,"body": `FOLLOW IG OWNER`,"previewType": "PHOTO","thumbnailUrl": `https://i.ibb.co/sHXWN3H/IMG-20211007-WA0067.jpg`,"thumbnail": Mthumb,"sourceUrl": `https://instagram.com/fisal.adriansyah`}}})
        }
...
"previewType": "PHOTO",
"thumbnailUrl": `https://i.ibb.co/sHXWN3H/IMG-20211007-WA0067.jpg`,
"thumbnail": Mthumb,
...
anus = sender
uwu = '```'
var menu = `_Simple Bot Whatsapp With Nodejs_
...
*٬࿊⃟🐼* ${prefix}setprefix *query*
*٬࿊⃟🐼* ${prefix}setlink *query*
*٬࿊⃟🐼* ${prefix}addcmd *reply*
*٬࿊⃟🐼* ${prefix}listcmd
*٬࿊⃟🐼* ${prefix}leave *id*
*٬࿊⃟🐼* ${prefix}self *Self*
*٬࿊⃟🐼* ${prefix}public *Public*
*٬࿊⃟🐼* ${prefix}off *query*
*٬࿊⃟🐼* ${prefix}on *Online*
*٬࿊⃟🐼* ${prefix}status *Status*
*٬࿊⃟🐼* ${prefix}autovn *on/off*
*٬࿊⃟🐼* ${prefix}autoketik *on/off*
*٬࿊⃟🐼* ${prefix}set vn *autovn*
*٬࿊⃟🐼* ${prefix}set ngetik *autoketik*
*٬࿊⃟🐼* ${prefix}antibug *on/off*
*٬࿊⃟🐼* ${prefix}antitag *on/off*
*٬࿊⃟🐼* ${prefix}autoread *query*
*٬࿊⃟🐼* ${prefix}anticall *on/off*
*٬࿊⃟🐼* ${prefix}antidelete *on/off*
*٬࿊⃟🐼* ${prefix}join *link*
*٬࿊⃟🐼* ${prefix}restart *Restart*

 𝙂𝙍𝙊𝙐𝙋

*٬࿊⃟🐼* ${prefix}antilink *1/0*
*٬࿊⃟🐼* ${prefix}antiviewonce *on/off*
*٬࿊⃟🐼* ${prefix}setname *query*
*٬࿊⃟🐼* ${prefix}setdesc *query*
*٬࿊⃟🐼* ${prefix}groupinfo *Info*
*٬࿊⃟🐼* ${prefix}revoke *Revoke*
*٬࿊⃟🐼* ${prefix}linkgc *Link Group*
*٬࿊⃟🐼* ${prefix}group *open/close*
*٬࿊⃟🐼* ${prefix}add *62xxxx*
*٬࿊⃟🐼* ${prefix}kick *reply*
*٬࿊⃟🐼* ${prefix}sider *reply*
*٬࿊⃟🐼* ${prefix}promote *reply*
*٬࿊⃟🐼* ${prefix}demote *reply*

 𝙎𝙀𝙏 𝘼𝙉𝙏𝙄𝙇𝙄𝙉𝙆

*٬࿊⃟🐼* ${prefix}setlink com *anti .com*
*٬࿊⃟🐼* ${prefix}setlink id *anti id*
*٬࿊⃟🐼* ${prefix}setlink xyz *anti xyz*
*٬࿊⃟🐼* ${prefix}setlink http *anti http*
*٬࿊⃟🐼* ${prefix}setlink Iy *anti Iy*
*٬࿊⃟🐼* ${prefix}setlink wa *anti wa*
*٬࿊⃟🐼* ${prefix}setlink default *default*

 𝙏𝙀𝙓𝙏𝙈𝘼𝙆𝙀𝙍

*٬࿊⃟🐼* ${prefix}phy glitch *name|text*
*٬࿊⃟🐼* ${prefix}phy coffecup *text*
*٬࿊⃟🐼* ${prefix}phy shadow *text*
*٬࿊⃟🐼* ${prefix}phy neon *text*
*٬࿊⃟🐼* ${prefix}blackpink *text*
*٬࿊⃟🐼* ${prefix}hartatahta *text*
*٬࿊⃟🐼* ${prefix}pornhub *text*
*٬࿊⃟🐼* ${prefix}natural *text*
*٬࿊⃟🐼* ${prefix}water *text*
*٬࿊⃟🐼* ${prefix}christimas *text*
*٬࿊⃟🐼* ${prefix}3d *text*
*٬࿊⃟🐼* ${prefix}romantic *text*
*٬࿊⃟🐼* ${prefix}naruto *text*
*٬࿊⃟🐼* ${prefix}love *text*
*٬࿊⃟🐼* ${prefix}love2 *text*
*٬࿊⃟🐼* ${prefix}butterfly *text*
*٬࿊⃟🐼* ${prefix}retro *text*
*٬࿊⃟🐼* ${prefix}wanted *link|name|text*

 𝙎𝙏𝘾𝙈𝘼𝙆𝙀𝙍

*٬࿊⃟🐼* ${prefix}sticker *image/video*
*٬࿊⃟🐼* ${prefix}swm *author|packname*
*٬࿊⃟🐼* ${prefix}take *author|packname*
*٬࿊⃟🐼* ${prefix}fdeface *reply*
*٬࿊⃟🐼* ${prefix}emoji *emoji*
*٬࿊⃟🐼* ${prefix}attp *teks*
*٬࿊⃟🐼* ${prefix}ttp *teks*

 𝘾𝙊𝙉𝙑𝙀𝙍𝙏

*٬࿊⃟🐼* ${prefix}toimg *reply*
*٬࿊⃟🐼* ${prefix}tomp3 *reply*
*٬࿊⃟🐼* ${prefix}tomp4 *reply*
*٬࿊⃟🐼* ${prefix}slow *reply*
*٬࿊⃟🐼* ${prefix}fast *reply*
*٬࿊⃟🐼* ${prefix}reverse *reply*
*٬࿊⃟🐼* ${prefix}tourl *reply*
...
*٬࿊⃟🐼* ${prefix}nuliskiri *teks*
*٬࿊⃟🐼* ${prefix}nuliskanan *teks*
*٬࿊⃟🐼* ${prefix}foliokiri *teks*
*٬࿊⃟🐼* ${prefix}foliokanan *teks*
*٬࿊⃟🐼* ${prefix}shopee *query*
*٬࿊⃟🐼* ${prefix}ssweb *link*
*٬࿊⃟🐼* ${prefix}pantun
*٬࿊⃟🐼* ${prefix}resepmasakan *query*
*٬࿊⃟🐼* ${prefix}githubstalk *username*
*٬࿊⃟🐼* ${prefix}infogempa
*٬࿊⃟🐼* ${prefix}artimimpi *query*
*٬࿊⃟🐼* ${prefix}fancytext *query*
*٬࿊⃟🐼* ${prefix}wikipedia *query*

 𝙄𝙎𝙇𝘼𝙈

*٬࿊⃟🐼* ${prefix}surah *nomor*
*٬࿊⃟🐼* ${prefix}asmaulhusna
*٬࿊⃟🐼* ${prefix}kisahnabi *query*
*٬࿊⃟🐼* ${prefix}doaharian
*٬࿊⃟🐼* ${prefix}ayatkursi
*٬࿊⃟🐼* ${prefix}bacaanshalat
*٬࿊⃟🐼* ${prefix}tahlil
*٬࿊⃟🐼* ${prefix}doawirid
*٬࿊⃟🐼* ${prefix}hadist *query*
*٬࿊⃟🐼* ${prefix}jadwalsholat *query*
*٬࿊⃟🐼* ${prefix}niatsholat

 𝙐𝙋 𝙎𝙏𝙊𝙍𝙔

*٬࿊⃟🐼* ${prefix}upswteks *query*
*٬࿊⃟🐼* ${prefix}upswimage *image*
*٬࿊⃟🐼* ${prefix}upswvideo *video*

 𝙂𝘼𝙈𝙀

*٬࿊⃟🐼* ${prefix}tictactoe *@tag*
*٬࿊⃟🐼* ${prefix}cekhistory *Status*
*٬࿊⃟🐼* ${prefix}delsesi *game*
*٬࿊⃟🐼* ${prefix}tebakgambar
*٬࿊⃟🐼* ${prefix}caklontong

 𝙎𝙀𝙎𝙎𝙄𝙊𝙉

*٬࿊⃟🐼* ${prefix}jadibot *Premium*
*٬࿊⃟🐼* ${prefix}stopbot *Premium*
*٬࿊⃟🐼* ${prefix}listbot *Premium*

 𝙁𝙐𝙉

*٬࿊⃟🐼* ${prefix}hbd *date*
*٬࿊⃟🐼* ${prefix}slander *query*
*٬࿊⃟🐼* ${prefix}slanderpm *query*
*٬࿊⃟🐼* ${prefix}kontak *62xxxx*
*٬࿊⃟🐼* ${prefix}styletext *query*
*٬࿊⃟🐼* ${prefix}phy *query*
*٬࿊⃟🐼* ${prefix}bisakah *query*
*٬࿊⃟🐼* ${prefix}apakah *query*
*٬࿊⃟🐼* ${prefix}kapankah *query*
*٬࿊⃟🐼* ${prefix}jadian
*٬࿊⃟🐼* ${prefix}rate *reply*
*٬࿊⃟🐼* ${prefix}truth
*٬࿊⃟🐼* ${prefix}dare
...
*٬࿊⃟🐼* ${prefix}tag *62xxxx*
*٬࿊⃟🐼* ${prefix}tagall *query*
*٬࿊⃟🐼* ${prefix}hidetag *query*
*٬࿊⃟🐼* ${prefix}kontag *62xxxx*
*٬࿊⃟🐼* ${prefix}sticktag *reply*
*٬࿊⃟🐼* ${prefix}totag *reply*

 𝘿𝙊𝙒𝙉𝙇𝙊𝘼𝘿

*٬࿊⃟🐼* ${prefix}ytsearch *query*
*٬࿊⃟🐼* ${prefix}playstore *query*
*٬࿊⃟🐼* ${prefix}igstalk *query*
*٬࿊⃟🐼* ${prefix}play *query*
*٬࿊⃟🐼* ${prefix}video *query*
*٬࿊⃟🐼* ${prefix}ytmp3 *link*
*٬࿊⃟🐼* ${prefix}ytmp4 *link*
*٬࿊⃟🐼* ${prefix}ig *link*
*٬࿊⃟🐼* ${prefix}twmp4 *link*
*٬࿊⃟🐼* ${prefix}twmp3 *link*
*٬࿊⃟🐼* ${prefix}tiktok *link*
*٬࿊⃟🐼* ${prefix}ttmp3 *link* 
*٬࿊⃟🐼* ${prefix}fbmp4 *link*
*٬࿊⃟🐼* ${prefix}fbmp3 *link*
*٬࿊⃟🐼* ${prefix}brainly *query* 
*٬࿊⃟🐼* ${prefix}image *query*

 𝙎𝙀𝙏𝙏𝙄𝙉𝙂

*٬࿊⃟🐼* ${prefix}setthumb *reply*
*٬࿊⃟🐼* ${prefix}settarget *62xxxx*
*٬࿊⃟🐼* ${prefix}setfakeimg *reply*
*٬࿊⃟🐼* ${prefix}setreply *query*

 𝙏𝙊𝙊𝙇𝙎

*٬࿊⃟🐼* ${prefix}getname *reply*
*٬࿊⃟🐼* ${prefix}getbio *reply*
*٬࿊⃟🐼* ${prefix}getpic *query*
*٬࿊⃟🐼* ${prefix}getp *From*
*٬࿊⃟🐼* ${prefix}get *link*
*٬࿊⃟🐼* ${prefix}q *Copy Paste*
*٬࿊⃟🐼* ${prefix}inspect *link*
*٬࿊⃟🐼* ${prefix}searchtext *query*
*٬࿊⃟🐼* ${prefix}searchgc *query*
*٬࿊⃟🐼* ${prefix}detikvn *query*
*٬࿊⃟🐼* ${prefix}detikvideo *query*
*٬࿊⃟🐼* ${prefix}tohuruf *query*
*٬࿊⃟🐼* ${prefix}fliptext *query*
*٬࿊⃟🐼* ${prefix}volume *query*

 𝙏𝙊𝙊𝙇𝙎

*٬࿊⃟🐼* ${prefix}gci *Group Invite*
*٬࿊⃟🐼* ${prefix}blocklist *List*
*٬࿊⃟🐼* ${prefix}setcmd *query*
*٬࿊⃟🐼* ${prefix}delcmd *Delete*
*٬࿊⃟🐼* ${prefix}listcmd *List*
*٬࿊⃟🐼* ${prefix}spam *query*
*٬࿊⃟🐼* ${prefix}listgroup *List*
*٬࿊⃟🐼* ${prefix}size *query*
*٬࿊⃟🐼* ${prefix}ping *Ping*
*٬࿊⃟🐼* ${prefix}term *code*
*٬࿊⃟🐼* ${prefix}owner *Owner*
*٬࿊⃟🐼* ${prefix}deletepc *Clear*
*٬࿊⃟🐼* ${prefix}google *query*
